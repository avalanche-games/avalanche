...
public class Main : Aval.Game {
	...
	public static void main () {
		...
		WINDOW = new SDL.Graphics.Window ("Shooter", SDL.Graphics.Window.POS_CENTERED,
			SDL.Graphics.Window.POS_CENTERED, 800, 480, SDL.Graphics.WindowFlags.SHOWN | SDL.Graphics.WindowFlags.RESIZABLE);
