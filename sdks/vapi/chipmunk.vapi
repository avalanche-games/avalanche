...
namespace cp {
	...
	[CCode (cname="cpPolyShape", cheader_filename = "chipmunk/chipmunk.h")]
	[Compact]
	public class PolyShape : cp.Shape {
		...
		[CCode (cname = "cpPolyShapeNew2")]
		public PolyShape.with_radius (cp.Body body, [CCode (array_length_pos = 1.9)] cp.Vect[] verts, cp.Vect offset, float radius);
		...
		[CCode (cname = "cpPolyShapeSetVerts")]
		public void set_verts ([CCode (array_length_pos = 0.9)] cp.Vect[] verts);
		[CCode (cname = "cpPolyShapeSetRadius")]
		public void set_radius (float radius);
		[CCode (cname = "cpPolyShapeGetVert")]
		public cp.Vect get_vert (int idx);
		[CCode (cname = "cpPolyShapeGetRadius")]
	...
	public class Space {
		...
		[CCode (cname = "cpSpaceConvertBodyToStatic")]
		public void body_tostatic (cp.Body body);
		[CCode (cname = "cpSpaceConvertBodyToDynamic")]
		public void body_todynamic (cp.Body body, float mass, float moment);
	...
	[CCode (cname="uint32_t", cheader_filename = "chipmunk/chipmunk.h")]
	[Compact]
	...
	[CCode (cheader_filename = "chipmunk/chipmunk.h")]
	public delegate cp.CollisionID SpatialIndexQueryFunc (void* obj1, void* obj2, cp.CollisionID id, void *data);
	[CCode (cheader_filename = "chipmunk/chipmunk.h")]
	...
	public class BoxShape : cp.PolyShape {
		...
		public static BoxShape.with_height (cp.Body body, cp.BB box, float height);
		[CCode (cheader_filename = "chipmunk/chipmunk.h", cname = "cpBoxShapeNew2")]
		public static BoxShape (cp.Body body, cp.BB box);
		[CCode (cheader_filename = "chipmunk/chipmunk.h", cname = "cpBoxShapeNew3")]
		public static BoxShape.with_radius (cp.Body body, cp.BB box, float radius);
	}
